...
{
	g_video_cap_ptr = new VideoSource();
	if (g_video_cap_ptr->open_camera())
	{
		return true;
	}
	else
...
{
	cv::Mat src_rgba;
	src_rgba = g_video_cap_ptr->get_left_rgba();
